...
EMPLOYEE_INITIAL_MEMORY_FILES: dict[str, str] = {
    ...
    PERSONA_FILE: (
        "# 人格笔记（soul.md）\n\n"
        "## 作用\n"
        "- 记录数字员工的长期人格特征、表达习惯与行为偏好。\n\n"
        "## 写入范围\n"
        "- 稳定个性：语气、风格、价值倾向、沟通方式。\n"
        "- 长期偏好：例如“先结论后细节”“偏好表格化输出”。\n\n"
        "## 不应写入\n"
        "- 一次性任务安排、临时日程、素材库条目、纯流程规范。\n\n"
        "## 当前记录\n"
        "- 暂无。\n"
    ),
    SCHEDULE_FILE: (
        "# 日程表（schedule.md）\n\n"
        "## 作用\n"
        "- 记录与时间相关的事项：待办、提醒、截止时间与周期安排。\n\n"
        "## 写入范围\n"
        "- 具体日期或时间点的任务、会议、里程碑、跟进节点。\n"
        "- 需要按时间顺序执行或提醒的工作安排。\n\n"
        "## 不应写入\n"
        "- 人格设定、工作习惯规范、素材库知识笔记。\n\n"
        "## 当前记录\n"
    ...
    WORKBOOK_FILE: (
        "# 工作手册（workbook.md）\n\n"
        "## 作用\n"
        "- 记录用户要求的长期工作习惯、执行规则与可复用流程。\n\n"
        "## 写入范围\n"
        "- 用户指定的流程模板、输出格式偏好、质量标准、检查清单。\n"
        "- 可长期复用的 SOP、协作约定与执行约束。\n\n"
        "## 不应写入\n"
        "- 单次任务临时安排、与素材库相关的内容、人格描述。\n\n"
        "## 当前记录\n"
        "- 暂无。\n"
    ),
    ASSET_PLACEHOLDER_FILE: (
        "# 素材库笔记（file.md）\n\n"
        "## 作用\n"
        "- 记录员工对素材库（brand_library）内容的长期笔记与索引。\n\n"
        "## 写入范围\n"
        "- 素材摘要、标签、用途说明、版本差异、引用建议。\n"
        "- 对素材库文件的结构化整理结论与检索线索。\n\n"
        "## 不应写入\n"
        "- 与素材库无关的日程信息、人格信息、工作习惯要求。\n\n"
        "## 当前记录\n"
        "- 暂无。\n"
    ),
}
